...
const CookieConsent = () => {
  ...
  const accept = () => { localStorage.setItem('cookieConsent', 'true'); setVisible(false) }
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-primary text-white p-4 shadow-lg z-50">
      <div className="container-custom flex flex-col sm:flex-row justify-between items-center gap-3">
        <p className="text-sm">We use cookies to enhance your experience. Please accept to enjoy the full features of our site.</p>
